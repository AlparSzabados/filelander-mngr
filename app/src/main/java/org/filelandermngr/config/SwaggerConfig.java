package org.filelandermngr.config;
...
public class SwaggerConfig {
    ...
    private static final String TITLE = "FilelanderMngr API Documentation";
    private static final String DESCRIPTION = "API documentation FilelanderMngr service";
